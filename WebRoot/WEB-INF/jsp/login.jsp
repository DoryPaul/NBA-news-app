...
<body style="font: 13px/20px 'Lucida Grande', Tahoma, Verdana, sans-serif;
  color: #404040;
  background: #0ca3d2;">
    ...
    <div class="login">
      <h1>用户登录</h1>
      <form method="post" action="${pageContext.request.contextPath }/checklogin.action">
        <p><input type="text" name="username" value="" placeholder="管理员"></p>
        <p><input type="password" name="password" value="" placeholder="密码"></p>
       <p class="remember_me">${errorLogin}</p>
